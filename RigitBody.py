...
if __name__=="__main__":
    ...
    p_word = transform_point(world_R, world_origin, p_local)
    print("Local point:", p_local)
    print("World point:", p_word)
    ...
    plot_frame(ax2, world_R, world_origin, "Transfore frame", length=1)
    ax2.scatter(p_local[0], p_local[1],p_local[2], color='magenta',s=50,label='p in local frame')
